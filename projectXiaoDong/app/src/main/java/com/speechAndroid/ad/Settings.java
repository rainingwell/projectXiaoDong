...
import com.speechAndroid.feedback.MyApp;
...
public class Settings {
    ...
    private void initSettings() {
        mPreference = MyApp.getAppContext().getSharedPreferences(Preference_Name, Activity.MODE_PRIVATE);
    ...
    public String getKeyWordsAsString() { return TextUtils.join(" ", listKeyWords); }
